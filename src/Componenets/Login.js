    ...
    <div>
      ...
      <div className="absolute">
        ...
        <form
          ...
          className="z-50 absolute top-1/4 right-1/3 bg-black text-white p-12 w-3/12  mr-20 bg-opacity-80 rounded-md ">
          ...
          <button
            onClick={handleClick}
            className="w-full m-2  p-3 bg-red-600 text-white">
            {isSignInForm ? "Sign In" : "Sign Up"}
          </button>
